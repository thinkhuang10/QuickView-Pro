...
namespace QuickView_Pro
{
    public partial class NewProject : Form
    {
        ...
        private async void btOK_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        MessageBox.Show("请输入工程名称！", ConstantHelper.SoftwareName, 
            ...
            //    {
            //        MessageBox.Show("请输入工程路径！", ConstantHelper.SoftwareName, 
            //            MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //        return;
            //    }
            ...
            //    {
            //        MessageBox.Show("工程名称已存在，请修改！", ConstantHelper.SoftwareName, 
            //            MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //        return;            
            //    }
            ...
            //        // 兼容老版本DView: 设备拓扑及变量表文件
            //        File.WriteAllBytes(Path.Combine(projectPath, "变量表.var"), Resource.变量表);
            //        File.WriteAllBytes(Path.Combine(projectPath, "设备拓扑.dtp"), Resource.设备拓扑);
